		...
		Versions: []VersionedCheck{
			{
				...
				CheckPod:       withOptions(hostProbesAndHostLifecycleV1Dot34),
			},
		},
	}
}

func hostProbesAndHostLifecycleV1Dot34(podMetadata *metav1.ObjectMeta, podSpec *corev1.PodSpec, opts options) CheckResult {
